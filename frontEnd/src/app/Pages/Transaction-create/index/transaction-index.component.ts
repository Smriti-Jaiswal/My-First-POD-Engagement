...
export class TransactionIndexComponent implements AfterViewInit, OnInit {
  displayedColumns: string[] = ['date', 'type', 'amount', 'username'];
  ...
  getAll(): void {
    this.utilService.getUserTransaction()
    .subscribe((resp) => {
